...
Environment:
  ...
  WMR_CONTROLLER_AIM_YAW_DEGREES_LEFT/RIGHT
                                Per-hand aim-pose yaw correction; defaults to
                                WMR_CONTROLLER_AIM_YAW_DEGREES.
  STEAMVR_EMULATE_INDEX_CONTROLLER
                                Present controllers to SteamVR as Index
                                controllers for render models and compatibility;
                                default true.
...
export WMR_CONTROLLER_AIM_YAW_DEGREES_LEFT
export WMR_CONTROLLER_AIM_YAW_DEGREES_RIGHT
