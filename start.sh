...
WMR_CONTROLLER_MIN_BRIGHT_PIXELS="${WMR_CONTROLLER_MIN_BRIGHT_PIXELS:-20}"
WMR_CONTROLLER_MAX_BRIGHT_PIXELS="${WMR_CONTROLLER_MAX_BRIGHT_PIXELS:-5000}"
